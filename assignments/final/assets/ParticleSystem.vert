...
//Forces
uniform vec3		_Gravity				= vec3(0, -5.0, 0);
...
uniform vec3		_ParticleDirectionMin	= vec3(-200,500,-200);
uniform vec3		_ParticleDirectionMax	= vec3(200,500,200);
uniform float		_ParticleSpread			= 0.0;
uniform float		_ParticleVelocityStart	= 100.0;
uniform float		_ParticleVelocityEnd	= 50.0;
...
uniform float		_ParticleEndSize		= 0.25;
